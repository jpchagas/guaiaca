...
import { Button, TextField, Typography, Link, Stack, Alert, Divider } from "@mui/material";
    ...
    <AuthLayout title="Forgot Password" subtitle="Enter your email to receive a reset link">
      ...
      <form onSubmit={handleResetPassword}>
        <Stack spacing={2}>
          ...
          <Button type="submit" variant="contained" fullWidth disabled={loading}>{loading ? "Sending..." : "Send Reset Email"}</Button>
        </Stack>
      </form>
